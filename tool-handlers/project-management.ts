...
export const handleProjectManagementTools = async (request: any) => {
  switch (request.params.name) {
    ...
    case "list_project_members": {
      ...
      const members = await project.listProjectMembersFunc(
        args.organizationId,
        args.id,
        args.name,
        args.roleId
    ...
    case "list_workitem_attachments": {
      ...
      const attachments = await workitem.listWorkitemAttachmentsFunc(
        args.organizationId,
        args.workItemId
      );
      return {
    ...
    case "get_workitem_file": {
      ...
      const file = await workitem.getWorkitemFileFunc(
        args.organizationId,
        args.workItemId,
        args.fileId
      );
    ...
    case "create_workitem_relation_record": {
      ...
      const result = await workitem.createWorkitemRelationRecordFunc(
        args.organizationId,
        args.workItemId,
        args.relationType,
