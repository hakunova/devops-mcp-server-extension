...
// Work item activity related schemas
export const ActivityValueSchema = z.object({
  displayValue: z.string().nullable().optional().describe("显示的名称"),
  identifier: z.string().nullable().optional().describe("值的唯一标识"),
});

export const ActivityOperatorSchema = z.object({
  id: z.string().nullable().optional().describe("用户id"),
  name: z.string().nullable().optional().describe("名称"),
});

export const ActivityPropertySchema = z.object({
  propertyId: z.string().nullable().optional().describe("属性id"),
  propertyName: z.string().nullable().optional().describe("属性名称"),
  propertyType: z.string().nullable().optional().describe("属性类型, 可选值为 Field，Relation 或是 null"),
});

export const ActivityRelatedResourceSchema = z.object({
  resourceId: z.string().nullable().optional().describe("资源id，如果是工作项则是对应的工作项id"),
  resourceType: z.string().nullable().optional().describe("资源对象，如果是工作项则是 Workitem"),
});
...
export const WorkItemActivitySchema = z.object({
  ...
  operator: ActivityOperatorSchema.nullable().optional().describe("操作者"),
  parentEventId: z.number().int().nullable().optional().describe("parentEventId"),
  property: ActivityPropertySchema.nullable().optional().describe("属性"),
  relatedResource: ActivityRelatedResourceSchema.nullable().optional().describe("关联资源"),
  resourceId: z.string().nullable().optional().describe("事件发生的资源对象id，工作项则是对应的工作项id"),
});
...
// Work item attachment related schemas
export const AttachmentCreatorSchema = z.object({
  id: z.string().nullable().optional().describe("用户id"),
  name: z.string().nullable().optional().describe("名称"),
});

export const WorkItemAttachmentSchema = z.object({
  creator: AttachmentCreatorSchema.nullable().optional().describe("创建者"),
  ...
  id: z.string().nullable().optional().describe("附件id"),
  modifier: AttachmentCreatorSchema.nullable().optional().describe("修改者"),
...
// Work item file related schemas
export const WorkItemFileSchema = z.object({
  id: z.string().nullable().optional().describe("文件id"),
  name: z.string().nullable().optional().describe("文件名称"),
  size: z.number().int().nullable().optional().describe("文件大小"),
  suffix: z.string().nullable().optional().describe("文件后缀"),
  url: z.string().nullable().optional().describe("文件下载地址，是个临时的下载地址，有时效性"),
});
...
export const GetWorkitemFileSchema = z.object({
  organizationId: z.string().describe("企业ID，可在组织管理后台的基本信息页面获取"),
  workItemId: z.string().describe("工作项唯一标识"),
  fileId: z.string().describe("文件唯一标识"),
});
...
export const WorkItemRelationRecordSchema = z.object({
  ...
  resourceType: z.string().nullable().optional().describe("关联的资源类型"),
});

export const ListWorkitemRelationRecordsSchema = z.object({
  organizationId: z.string().describe("企业ID，可在组织管理后台的基本信息页面获取"),
  workItemId: z.string().describe("工作项唯一标识"),
  relationType: z.enum(["PARENT", "SUB", "ASSOCIATED", "DEPEND_ON", "DEPENDED_BY"]).describe("关联类型，PARENT-父项，SUB-子项，ASSOCIATED-关联项，DEPEND_ON-依赖项，DEPENDED_BY-支撑项"),
});

// Create work item relation record schema
export const CreateWorkitemRelationRecordSchema = z.object({
  organizationId: z.string().describe("企业ID，可在组织管理后台的基本信息页面获取"),
  workItemId: z.string().describe("工作项唯一标识"),
  relationType: z.enum(["PARENT", "SUB", "ASSOCIATED", "DEPEND_ON", "DEPENDED_BY"]).describe("关联类型，PARENT-父项，SUB-子项，ASSOCIATED-关联项，DEPEND_ON-依赖项，DEPENDED_BY-支撑项"),
  relatedWorkitemId: z.string().describe("关联的工作项ID"),
});

// Delete work item relation record schema
export const DeleteWorkitemRelationRecordSchema = z.object({
  organizationId: z.string().describe("企业ID，可在组织管理后台的基本信息页面获取"),
  workItemId: z.string().describe("工作项唯一标识"),
  relationType: z.enum(["PARENT", "SUB", "ASSOCIATED", "DEPEND_ON", "DEPENDED_BY"]).describe("关联类型，PARENT-父项，SUB-子项，ASSOCIATED-关联项，DEPEND_ON-依赖项，DEPENDED_BY-支撑项"),
  relatedWorkitemId: z.string().describe("要删除关联的工作项ID"),
});
...
export const ProjectMemberSchema = z.object({
  roleId: z.string().nullable().optional().describe("Role unique identifier, e.g., project.admin"),
  roleName: z.string().nullable().optional().describe("Role name, e.g., 管理员"),
  userAvatar: z.string().nullable().optional().describe("User avatar URL"),
  userId: z.string().nullable().optional().describe("User unique identifier"),
...
export const ListProjectMembersSchema = z.object({
  ...
  roleId: z.string().optional().describe("Role ID filter, e.g., project.admin for administrator"),
});
